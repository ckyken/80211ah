...
int main(int argc, char *argv[])
{
  ...
  /////////////////////////////////////////////////////////////////////////
  YansWifiPhyHelper wifiPhy_2 = YansWifiPhyHelper::Default();
  // set it to zero; otherwise, gain will be added
  wifiPhy_2.Set("RxGain", DoubleValue(-10));

  YansWifiPhyHelper wifiPhy_3 = YansWifiPhyHelper::Default();
  // set it to zero; otherwise, gain will be added
  wifiPhy_3.Set("RxGain", DoubleValue(-10));

  //channel 2
  YansWifiChannelHelper wifiChannel_2;
  wifiChannel_2.SetPropagationDelay("ns3::ConstantSpeedPropagationDelayModel");
  wifiChannel_2.AddPropagationLoss("ns3::FriisPropagationLossModel");
  wifiPhy_2.SetChannel(wifiChannel_2.Create());

  //channel 3
  YansWifiChannelHelper wifiChannel_3;
  wifiChannel_3.SetPropagationDelay("ns3::ConstantSpeedPropagationDelayModel");
  wifiChannel_3.AddPropagationLoss("ns3::FriisPropagationLossModel");
  wifiPhy_3.SetChannel(wifiChannel_3.Create());
